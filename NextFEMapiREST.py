...
class NextFEMrest:
    ...
    def addMeshedWall(self, ID, origX, origY, origZ, div1, div2, plan, leng, hei, angle, tilt, nodeOffset, isHorizontal): return json.loads(self.nfrest('GET', '/op/mesh/addmeshedwall/'+str(ID)+'/'+str(origX)+'/'+str(origY)+'/'+str(origZ)+'/'+str(div1)+'/'+str(div2)+'/'+str(plan)+'/'+str(leng)+'/'+str(hei)+'/'+str(angle)+'/'+str(tilt)+'/'+str(nodeOffset)+'/'+str(isHorizontal)+'', None, None))
    ...
    def addSpringsOnOverlappedNodes(self, n, propName): return json.loads(self.nfrest('POST', '/element/add/springsonnodes/'+str(propName)+'', n, None))
    ...
    def AnalyzeFireElement(self, elem, endTime, beamExposure, columnExposure, checkCombo, selectForcesCrit, fireCurve, outOfProc, noWindow, customFireCurve): return json.loads(self.nfrest('GET', '/res/check/analyzefire/'+str(elem)+'/'+str(endTime)+'/'+str(beamExposure)+'/'+str(columnExposure)+'/'+str(checkCombo)+'/'+str(selectForcesCrit)+'/'+str(fireCurve)+'/'+str(outOfProc)+'/'+str(noWindow)+'/'+str(customFireCurve)+'', None, None))
    ...
    def divideHexa(self, hexaID, divX, divY, divZ): return json.loads(self.nfrest('GET', '/op/mesh/dividehexa/'+str(hexaID)+'/'+str(divX)+'/'+str(divY)+'/'+str(divZ)+'', None, None))
    def divideLine(self, lines, fractions): return json.loads(self.nfrest('GET', '/op/mesh/divideline', None, dict([("lines", lines), ("fractions", fractions)])))
    def divideLineByNodes(self, line, nodes): return self.nfrest('GET', '/op/mesh/dividelinebynodes/'+str(line)+'', None, dict([("nodes", nodes)]))
    def divideQuad(self, quadID, divX, divY): return json.loads(self.nfrest('GET', '/op/mesh/dividequad/'+str(quadID)+'/'+str(divX)+'/'+str(divY)+'', None, None))
    def divideWedge(self, wedgeID, div): return json.loads(self.nfrest('GET', '/op/mesh/dividewedge/'+str(wedgeID)+'/'+str(div)+'', None, None))
    ...
    def getAnalysisTimeSteps(self, lc): return json.loads(self.nfrest('GET', '/res/steps/'+str(lc)+'', None, None))
    def getAreaByNodes(self, nodes): return self.nfrest('POST', '/node/area', nodes, None)
    def getBC(self, node): return json.loads(self.nfrest('GET', '/bc/get/'+str(node)+'', None, None))
    ...
    def getBeamForces(self, num, loadcase, station, time): return json.loads(self.nfrest('GET', '/res/beamforces/'+str(num)+'/'+str(loadcase)+'/'+str(station)+'/'+str(time)+'', None, None))
    def getBeamForcesAtNode(self, elem, node, loadcase, time): return json.loads(self.nfrest('GET', '/res/beamforcesatnode/'+str(elem)+'/'+str(node)+'/'+str(loadcase)+'/'+str(time)+'', None, None))
    ...
    def getBeamResMoments(self, elemID): return json.loads(self.nfrest('GET', '/res/check/beammoments/'+str(elemID)+'', None, None))
    def getBeamResShear(self, elemID, loadcase, time): return json.loads(self.nfrest('GET', '/res/check/beamshearres/'+str(elemID)+'/'+str(loadcase)+'/'+str(time)+'', None, None))
    ...
    def getConnectedElements(self, node, onlyOfType): return json.loads(self.nfrest('GET', '/node/connectedelements/'+str(node)+'/'+str(onlyOfType)+'', None, None))
    def getControlNode(self): return self.nfrest('GET', '/op/controlnode', None, None)
    def getCornerNodes(self, nodes, lcs): return json.loads(self.nfrest('GET', '/op/corners', None, dict([("nodes", nodes), ("lcs", lcs)])))
    ...
    def getDesignMaterialsLibrary(self, filter, type): return json.loads(self.nfrest('GET', '/designmaterials/library/'+str(filter)+'/'+str(type)+'', None, None))
    def getDesignMaterialsLibrary(self, filename, filter, type): return json.loads(self.nfrest('GET', '/designmaterials/libraryf/'+str(filename)+'/'+str(filter)+'/'+str(type)+'', None, None))
    def getElementArea(self, ID): return self.nfrest('GET', '/element/area/'+str(ID)+'', None, None)
    def getElementCentroid(self, ID): return json.loads(self.nfrest('GET', '/element/centroid/'+str(ID)+'', None, None))
    def getElementChecks(self, ID, lc, time): return self.nfrest('GET', '/res/check/elementA/'+str(ID)+'/'+str(lc)+'/'+str(time)+'', None, None)
    def getElementConnectivity(self, ID): return json.loads(self.nfrest('GET', '/element/conn/'+str(ID)+'', None, None))
    ...
    def getElementInfo(self, element): return json.loads(self.nfrest('GET', '/element/info/'+str(element)+'', None, None))
    def getElementOffset(self, elem): return json.loads(self.nfrest('GET', '/element/beamoffset/'+str(elem)+'', None, None))
    def getElementProperty(self, ID, name): return self.nfrest('GET', '/element/prop/'+str(ID)+'/'+str(name)+'', None, None)
    def getElementRebarSegments(self, elem): return json.loads(self.nfrest('GET', '/section/rebar/segments/'+str(elem)+'', None, None))
    def getElementsChecks(self, lc, time): return json.loads(self.nfrest('GET', '/res/check/elementsA/'+str(lc)+'/'+str(time)+'', None, None))
    def getElementsChecksByMat(self, mat): return json.loads(self.nfrest('GET', '/res/check/elementsM/'+str(mat)+'', None, None))
    def getElementsFromGroup(self, name): return json.loads(self.nfrest('GET', '/group/elements/'+str(name)+'', None, None))
    ...
    def getEndRelease(self, beamID): return json.loads(self.nfrest('GET', '/element/beamendrelease/'+str(beamID)+'', None, None))
    def getEnvelopeCombination(self, name): return self.nfrest('GET', '/loadcase/combo/getenv/'+str(name)+'', None, None)
    def getExtrudedBeamPoints(self, elemID): return json.loads(self.nfrest('GET', '/element/extrudedbeam/'+str(elemID)+'', None, None))
    ...
    def getLoadsForElement(self, element): return json.loads(self.nfrest('GET', '/load/element/get/'+str(element)+'', None, None))
    def getLoadsForNode(self, node): return json.loads(self.nfrest('GET', '/load/node/get/'+str(node)+'', None, None))
    def getLoadsInLoadcase(self, loadcase): return json.loads(self.nfrest('GET', '/load/inloadcase/'+str(loadcase)+'', None, None))
    def getLocalAxes(self, ID): return json.loads(self.nfrest('GET', '/element/lcs/'+str(ID)+'', None, None))
    def getLocalAxesArray(self, ID): return json.loads(self.nfrest('GET', '/element/lcsA/'+str(ID)+'', None, None))
    def getMacroelement(self, elemID): return self.nfrest('GET', '/element/macro/'+str(elemID)+'', None, None)
    def getMaterialsLibrary(self, filter, type): return json.loads(self.nfrest('GET', '/materials/library/'+str(filter)+'/'+str(type)+'', None, None))
    def getMaterialsLibrary(self, filename, filter, type): return json.loads(self.nfrest('GET', '/materials/libraryf/'+str(filename)+'/'+str(filter)+'/'+str(type)+'', None, None))
    ...
    def getMaxMinWoodArmerMoments(self, groupName): return json.loads(self.nfrest('GET', '/res/maxminwoodarmerg/'+str(groupName)+'', None, None))
    def getMemberElements(self, member): return json.loads(self.nfrest('GET', '/model/member/elems/'+str(member)+'', None, None))
    ...
    def getNodeCoordinates(self, ID): return json.loads(self.nfrest('GET', '/node/ID', None, None))
    def getNodeInfo(self, node): return json.loads(self.nfrest('GET', '/node/info/'+str(node)+'', None, None))
    ...
    def getNodesChecks(self, lc, time): return json.loads(self.nfrest('GET', '/res/check/nodesA/'+str(lc)+'/'+str(time)+'', None, None))
    ...
    def getNodesFromGroup(self, name): return json.loads(self.nfrest('GET', '/group/nodes/'+str(name)+'', None, None))
    def getNodesOnSides(self, nodes, tol): return json.loads(self.nfrest('GET', '/op/mesh/borders/'+str(tol)+'', None, dict([("nodes", nodes)])))
    def getOSprocedureName(self): return self.nfrest('GET', '/op/export/osproc', None, None)
    def getParticipatingMassesRatios(self, mode, loadcase): return json.loads(self.nfrest('GET', '/res/partmasses/'+str(mode)+'/'+str(loadcase)+'', None, None))
    def getParticipationFactors(self, mode, loadcase): return json.loads(self.nfrest('GET', '/res/partfactors/'+str(mode)+'/'+str(loadcase)+'', None, None))
    ...
    def getResultHistory(self, loadcase, itemID, resultType, resultID1, resultID2): return json.loads(self.nfrest('GET', '/res/hist/'+str(loadcase)+'/'+str(itemID)+'/'+str(resultType)+'/'+str(resultID1)+'/'+str(resultID2)+'', None, None))
    def getRigidDiaphragms(self): return json.loads(self.nfrest('GET', '/op/mesh/rigiddiaph', None, None))
    def getRigidOffsets(self, beamID): return json.loads(self.nfrest('GET', '/element/beamendoffset/'+str(beamID)+'', None, None))
    ...
    def getSectionOffset(self, ID): return json.loads(self.nfrest('GET', '/section/set/offset/'+str(ID)+'', None, None))
    def getSectionProperties(self, ID): return json.loads(self.nfrest('GET', '/section/props/'+str(ID)+'', None, None))
    def getSectionProperty(self, ID, name): return self.nfrest('GET', '/section/prop/'+str(ID)+'/'+str(name)+'', None, None)
    def getSectionRebarCoords(self, ID): return json.loads(self.nfrest('GET', '/section/rebar/coords/'+str(ID)+'', None, None))
    ...
    def getSectionResShear(self, sectionID, N, Mzz, Myy, Vy, Vz): return json.loads(self.nfrest('GET', '/op/sectioncalc/shear/'+str(sectionID)+'/'+str(N)+'/'+str(Myy)+'/'+str(Mzz)+'/'+str(Vy)+'/'+str(Vz)+'', None, None))
    def getSectionResShear(self, sectionID, verName, N, Mzz, Myy, Vy, Vz): return json.loads(self.nfrest('GET', '/op/sectioncalc/shear/'+str(sectionID)+'/'+str(verName)+'/'+str(N)+'/'+str(Myy)+'/'+str(Mzz)+'/'+str(Vy)+'/'+str(Vz)+'', None, None))
    def getSectionsLibrary(self, filter): return json.loads(self.nfrest('GET', '/sections/library/'+str(filter)+'', None, None))
    def getSectionsLibrary(self, filename, filter): return json.loads(self.nfrest('GET', '/sections/libraryf/'+str(filename)+'/'+str(filter)+'', None, None))
    ...
    def getShellEndRelease(self, ID): return json.loads(self.nfrest('GET', '/element/shellendrelease/'+str(ID)+'', None, None))
    ...
    def getSpringLocalAxes(self, elem): return json.loads(self.nfrest('GET', '/springproperty/axes/'+str(elem)+'', None, None))
    def getSubsoilElements(self): return json.loads(self.nfrest('GET', '/element/add/subsoil', None, None))
    def getTimePeriods(self, lc): return json.loads(self.nfrest('GET', '/res/periods/'+str(lc)+'', None, None))
    ...
    def getWallSection(self, grpName): return json.loads(self.nfrest('GET', '/element/walls/section/'+str(grpName)+'', None, None))
    ...
    def setFirePoint(self, loadcase, fireNode, targetTemp, gradientY, gradientZ, tempAtten, dontLoadUnder): return json.loads(self.nfrest('GET', '/load/firepoint/'+str(loadcase)+'/'+str(fireNode)+'/'+str(targetTemp)+'/'+str(gradientY)+'/'+str(gradientZ)+'/'+str(tempAtten)+'/'+str(dontLoadUnder)+'', None, None))
